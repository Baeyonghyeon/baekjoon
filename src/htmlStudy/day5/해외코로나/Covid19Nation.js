...
let receive = localStorage.getItem("country")
console.log(receive)
...
function parse(xmlDoc) {
    return new Promise(function (resolve, reject) {
        ...
        for (let i = 0; i < items.length; i++) {
            ...
            let createDt = items[i].getElementsByTagName("createDt")[0].innerHTML;  //나라
            let natDefCnt = items[i].getElementsByTagName("natDefCnt")[0].innerHTML;  //총 코로나 인원
